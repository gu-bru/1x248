(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1x248.loader.js";
    var config = {
        dataUrl: buildUrl + "/1x248.data",
        frameworkUrl: buildUrl + "/1x248.framework.js",
        codeUrl: buildUrl + "/1x248.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "G. Brunbauer",
        productName: "1x2_4_8",
        productVersion: "1.38 vom 24.8.2023",
    };
